package ntu.edu.appweather.Activity;
...
import ntu.edu.appweather.Adapters.FutureAdapter;
...
public class FutureActivity2 extends AppCompatActivity {
    ...
    private void setVaribale() {
        @SuppressLint("WrongViewCast") ConstraintLayout backBtn = findViewById(R.id.backBtn);
    ...
    private void initRecyclerView() {
        ...
        adapterNgaymai = new FutureAdapter(items);
